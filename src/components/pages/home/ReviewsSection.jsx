...
const SecPart = () => {
  ...
  return (
    <div className="flex min-h-screen p-3 justify-center items-center bg-black text-white">
      <div className="flex flex-col sm:flex-row items-start justify-around">
        <article className="sm:w-1/2 sm:pr-5">
          <div className="flex justify-center flex-col">
            <div className="flex flex-col items-start justify-center">
              <h2 className="text-3xl xl:text-3xl 2xl:text-6xl font-bold tracking-tight">
                People who trust us
              </h2>
              <p className="mt-2 text-sm xl:text-base 2xl:text-xl">
            ...
            <div className="group relative">
              <p className="mt-3 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify">
