...
export const Facial = () => (
  <div className="py-10 leading-tight text-justify">
    <div className="flex sm:flex-row">
      ...
      <div className="w-2/3 pl-5">
        ...
        <p className="text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
          ...
          Hydrafacial?”
          <br />
          If you are thinking of the same, this blog is for you. Scroll ahead to
          explore all about regular facials and Hydrafacial, their benefits, and
          their biggest differences so you can decide which one is better for
          you.
        </p>
        ...
        <p className="pt-2 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
          ...
          serums. The treatment works by removing all the makeup, oil, and dirt
          from the deepest layer of the skin.
        </p>
      </div>
    </div>
    <div>
      ...
      <p className="pt-2 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
        ...
        aesthetician or dermatologist cleanses your skin and exfoliates it. Once
        the pores are clear, the aesthetician infuses hydrating serums into your
        skin to make your skin glowing, hydrated, and protected. Lastly, the
        advanced device is used to replenish your face with rejuvenating
        methods. This involves the addition of protective serums, that will
        protect your pores from attracting dirt and other impurities after the
        procedure. Hydrafacial provides instantaneous and long-term results in
      ...
      <p className="pt-2 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
        Regular facials are facials commonly performed at beauty salons. It can
        also be done at home by buying a facial kit or mask. <br />
        ...
        cleansing with creams, skin exfoliation with scrubs, and peel-off masks.{" "}
        <br />
        There are various types of facials available in the market for specific
        skin conditions and concerns. Regular facials help regain skin
        nourishment lost due to daily exposure to sun, pollution, dust, and
        impurities. <br />
      ...
      <div className="w-2/3 pr-5">
        ...
        <div className="pt-2">
          ...
          <p className="pt-1 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            Unlike traditional facials, Hydrafacial treatment provides a gentle
            cleansing and rejuvenating experience, as well as does not cause any
            abrasions.
          </p>
        </div>
        <div className="pt-5">
        ...
        <div className="pt-5">
          <h3>Tightens Skin:</h3>
          <p className="pt-1 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            Hydrafacial restores your skin’s firmness and makes it tight, which
            prevents the collection of dirt in the pores.
          </p>
        </div>
        <div className="pt-5">
          <h3>Suitable For All Skin Types:</h3>
          <p className="pt-1 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            The most loved benefit of Hydrafacial is that it is suitable for all
            skin types and tones. It doesn’t cause any side effects or pain to
            any skin tone or type undergoing the treatment.
          </p>
        </div>
        <div className="pt-5">
          <h3>Long-Lasting Results:</h3>
          <p className="pt-1 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            Hydrafacial provides instant and long-lasting results that can last
            up to 4-6 weeks.
          </p>
        </div>
        <div className="pt-5">
          <h3>Customizable:</h3>
          <p className="pt-1 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            This advanced facial treatment can be easily customized according to
            your skin type, tone, and texture. Customizing your treatment makes
        ...
        <div className="pt-5">
          ...
          <p className="pt-1 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            Hydrafacial doesn’t only give an instant glow but is also effective
            in addressing various skin conditions.
          </p>
        </div>
      </div>
      <div className="w-1/3">
    ...
    <div className="flex flex-row pt-10 ">
      ...
      <div className="w-2/3 pl-5">
        ...
        <div className="pt-2">
          ...
          <p className="pt-1 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            Regular facials are a great way to cleanse your skin and remove all
            dead skin and dust from your skin.
          </p>
        </div>
        <div className="pt-5">
          ...
          <p className="pt-1 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            ...
            replenish your skin with the required dose of nutrients and serums.
          </p>
        </div>
        <div className="pt-5">
        ...
        <div className="pt-5">
          ...
          <p className="pt-1 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            Facials can lessen the severe effect of environmental pollution that
            causes the skin pores to clog, resulting in acne and pimple
            problems.
          </p>
        </div>
        <div className="pt-5">
          ...
          <p className="pt-1 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            ...
            tightens the skin and reduces the signs of aging, like wrinkles and
            sagging of the skin.
          </p>
        </div>
      </div>
    ...
    <div>
      <div>
        <div>
          ...
          <p className="pt-2 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            Hydrafacial is a facial treatment where a state-of-the-art device is
            used to deeply cleanse the skin and provide instant glowing skin,
            whereas regular facials are traditional methods of treating skin for
          ...
          <p className="pt-2 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            ...
            provides more satisfactory results. It rejuvenates the skin without
            causing any pain.
          </p>
          <p className="pt-2 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            ...
            effects. In contrast, products used in regular facials might contain
            chemicals that might cause side effects and worsen certain skin
            concerns like acne, pimples, and rosacea.
          </p>
          <p className="pt-2 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            Hydrafacial is also the most preferred choice for pregnant women, as
            they should not undergo chemical procedures that might cause harm to
            the baby.
          </p>
          ...
          <h3 className="text-start">
            After knowing all these details, which facial treatment do you find
            the best?
          </h3>
          <p className="pt-2 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
            There’s no doubt that discovering the best facial is quite a chore.
            To help you out, we’ve listed above every detail related to both
            regular facials and Hydrafacial to make it easy to choose the best
            one.
          </p>
          <p className="pt-2 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
