  ...
  return (
    <Scaffold>
      <article className="leading-tight">
        ...
        <div className="text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal text-justify">
          <section className="bg-white-bg h-screen flex justify-center items-center bg-cover bg-no-repeat">
            <div className="max-w-96 px-3">
              ...
              <p className="pt-2">
                <span className="font-bold">1. </span> Ease of Using Laser The
          ...
          <section className="h-screen flex flex-col justify-center items-center px-3 bg-black text-white">
          ...
          <section className="flex flex-col bg-white-bg bg-cover bg-no-repeat h-screen justify-center items-center">
          ...
          <section className="h-screen w-screen flex flex-col items-center justify-center bg-black text-white">
            <p className="max-w-96 px-3">
          ...
          <section className="bg-white-bg bg-cover bg-no-repeat h-screen flex flex-col justify-center items-center">
            <p className="max-w-96 px-3">
