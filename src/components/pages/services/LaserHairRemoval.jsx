...
export const LaserHairRemoval = () => {
  ...
  return (
    <Scaffold>
      <article className="py-10 flex flex-col sm:flex-row border-b border-gray-200">
        ...
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="sm:pl-5 sm:w-2/3">
            ...
            <p className="pt-2 text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
              ...
              laser hair removal is in high demand. Regarding this, the top 5
              factors contributing to the popularity are as follows:
            </p>
            <ul className="text-xs lg:text-sm xl:text-base 2xl:text-xl 2xl:leading-normal 2xl:mt-10 text-justify text-gray-600">
              <li className="pt-2">
                ...
                hair removal method offers pain-free, long-lasting solutions
                with fewer sessions over time than conventional hair removal
                techniques like waxing or shaving. When compared to the more
                frequent maintenance required by traditional hair removal
                techniques, laser hair removal offers long-lasting freedom from
                unwanted hairs just after a few sessions. The process is also
                reasonably quick and can be finished in a short time. As a
                result, individuals with hectic schedules can fit the treatment
                into their day without taking a significant amount of time out
                of it.
              </li>
              <li className="pt-2">
                ...
                removal techniques demand ongoing upkeep, such as frequent
                waxing or shaving, which can mount up quickly over time. On the
                other side, laser hair removal provides long-term hair removal,
                so eventually, you will require fewer sessions.
              </li>
              <li className="pt-2">
                ...
                grow back, or if it does, it will be considerably lighter in
                color and a lot thinner. Initially, laser lights destroyed the
                melanin in the hair follicle. Hence it worked effectively on
                dark hairs. But day by day, the technique is getting more
                advanced, and now, with the help of Lumenis Splandor X, the
                effective removal of all types of hair is possible. As a result,
                the treatment is extensively used by a larger population across
                the globe.
              </li>
              <li className="pt-2">
                ...
                sensitive skin. Contrarily, laser hair removal causes only a
                small amount of discomfort during the procedure and feels like a
              ...
              <li className="pt-2">
                ...
                significantly enhance confidence for those who deal with
                excessive hair growth. Many people find it embarrassing when
                their hair grows excessively, especially if it does so on their
                arms or faces, which are highly visible areas. The appearance of
                hair in these regions can be diminished with laser hair removal,
                enhancing people's self-confidence. Also, those who have had
                laser hair removal frequently state that they feel more at ease
                in their skin, which can benefit their overall confidence.
              </li>
            </ul>
          </div>
        </div>
